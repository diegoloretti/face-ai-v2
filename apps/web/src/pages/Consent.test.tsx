...
describe('Consent', () => {
  ...
  it('chama onAccept ao clicar em Aceitar', async () => {
    ...
    render(<Consent onAccept={onAccept} onReject={() => {}} onViewPrivacy={() => {}} />)
  ...
  it('chama onReject ao clicar em Recusar', async () => {
    ...
    render(<Consent onAccept={() => {}} onReject={onReject} onViewPrivacy={() => {}} />)
  ...
  it('link de política de privacidade chama onViewPrivacy', async () => {
    ...
    render(<Consent onAccept={() => {}} onReject={() => {}} onViewPrivacy={onViewPrivacy} />)
